...
#@pytest.mark.parametrize('list_dictionaries, state', [{'id': 41428829, 'state': 'EXECUTED', 'date': '2019-07-03T18:35:29.512364'},
...
def test_filter_no_state():
    with pytest.raises(KeyError):
        filter_by_state([{'id': 41428829, 'tate': 'EXECUTED', 'date': '2019-07-03T18:35:29.512364'},
...
def test_filter_for_any_state():
    with pytest.raises(ValueError):
        filter_by_state([{'id': 41428829, 'state': 'XECUTED', 'date': '2019-07-03T18:35:29.512364'},
...
def test_sort_by_date_decreasing():
    assert sort_by_date([{'id': 41428829, 'state': 'XECUTED', 'date': '2019-07-03T18:35:29.512364'},
                         {'id': 594226727, 'state': 'ANCELED', 'date': '2018-09-12T21:27:25.241689'},
                         {'id': 615064591, 'state': 'ANCELED', 'date': '2018-10-14T08:21:33.419441'},
                         {'id': 939719570, 'state': 'XECUTED', 'date': '2018-06-30T02:08:58.425572'}],
                        True) == [{'id': 41428829, 'state': 'XECUTED', 'date': '2019-07-03T18:35:29.512364'},
                         {'id': 615064591, 'state': 'ANCELED', 'date': '2018-10-14T08:21:33.419441'},
                         {'id': 594226727, 'state': 'ANCELED', 'date': '2018-09-12T21:27:25.241689'},
                         {'id': 939719570, 'state': 'XECUTED', 'date': '2018-06-30T02:08:58.425572'}]
...
def test_sort_by_date_up():
    assert sort_by_date([{'id': 41428829, 'state': 'XECUTED', 'date': '2019-07-03T18:35:29.512364'},
                         ...
                         {'id': 615064591, 'state': 'ANCELED', 'date': '2018-10-14T08:21:33.419441'},
                         {'id': 939719570, 'state': 'XECUTED', 'date': '2018-06-30T02:08:58.425572'}],
                        False) == [{'id': 939719570, 'state': 'XECUTED', 'date': '2018-06-30T02:08:58.425572'},
                         {'id': 594226727, 'state': 'ANCELED', 'date': '2018-09-12T21:27:25.241689'},
                         {'id': 615064591, 'state': 'ANCELED', 'date': '2018-10-14T08:21:33.419441'},
                         {'id': 41428829, 'state': 'XECUTED', 'date': '2019-07-03T18:35:29.512364'}]


def test_sort_by_date_ident():
    assert sort_by_date([{'id': 41428829, 'state': 'XECUTED', 'date': '2019-07-03T18:35:29.512364'},
                         {'id': 594226727, 'state': 'ANCELED', 'date': '2018-09-12T21:27:25.241689'},
...
def test_get_date_by_different_param(data):
    assert (len(data) == 26
            and data[0:4].isdigit() == True
            and data[5:7].isdigit() == True
            and data[8:10].isdigit() == True
            and data[4] == "-"
            and data[7] == "-"
            and data[10] == "Т"

...
#                                 [(all_transactions, "USD",
#                                 [{'id': 939719570, 'state': 'EXECUTED', 'date': '2018-06-30T02:08:58.425572',
#                                  'operationAmount': {'amount': '9824.07', 'currency': {'name': 'USD', 'code': 'USD'}},
#                                  'description': 'Перевод организации', 'from': 'Счет 75106830613657916952', 'to':
...
#                                 (all_transactions, "RUB",
#                                 [{"id": 873106923, "state": "EXECUTED", "date": "2019-03-23T01:09:46.296404",
#                                  "operationAmount": {"amount": "43318.34", "currency":
#                                 {"name": "руб.","code": "RUB"}}, "description": "Перевод со счета на счет",
...
def test_filter_by_currency(all_transactions) -> None:
    ...
    assert usd_transactions == [{'id': 939719570, 'state': 'EXECUTED', 'date': '2018-06-30T02:08:58.425572',
                                ...
                                {'id': 142264268, 'state': 'EXECUTED', 'date': '2019-04-04T23:20:05.206878',
                                 ...
                                 'currency': {'name': 'USD', 'code': 'USD'}}, 'description': 'Перевод с карты на карту',
...
def test_empty_currency():
    with pytest.raises(ValueError):
        ...
        # gen = "Не указана валюта транзакции"
